...
from TensorBallTreeSegmentation import tensorConnectedComponents, minCutRefinement
...
if __name__ == '__main__':
    ...
    tensors = segmentation2.getSegmentAttributes
    ...
    # temp = minCutRefinement(segmentation2.getSegmentAttributes, minSegmentSize=3)
