...
class TestPanoramaFactory(TestCase):
    def test_CreatePanorama_From_pts(self):
        try:
            pts = IOFactory.ReadPts(r'../../IOmodules/test_pts2.pts')
    ...
    def test_CreatePanorama_From_pts_intensity(self):
        try:
            ptslist = []
            colorlist = []
            pts = IOFactory.ReadPtx(r'../../IOmodules/test_ptx2.ptx')
    ...
    #         colorlist = []
    #         pts = []
    #         IOFactory.ReadPts(r'../Panoramas/panorama_test.pts', pts, colorlist,
    #                           merge=False)
