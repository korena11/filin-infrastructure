...
class BallTreePointSet(PointSet):
    ...
    def __init__(self, points, path=None, intensity=None, range_accuracy=0.002, angle_accuracy=0.012,
        ...
        """
        super(BallTreePointSet, self).__init__(points, path, intensity, range_accuracy, angle_accuracy,
                                               measurement_accuracy)

        self.__initializeBallTree(points, leaf_size)
    ...
    # ---------------- PRIVATES-------------
    def __initializeBallTree(self, inputPoints, leafsize):
        """
        ...
        if isinstance(inputPoints, np.ndarray):
            self.data = BallTree(inputPoints, leafsize)
